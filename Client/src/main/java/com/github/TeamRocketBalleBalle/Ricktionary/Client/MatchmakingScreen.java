...
public class MatchmakingScreen extends javax.swing.JFrame {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MatchmakingScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
    ...
    private void initComponents() {
        ...
        message.setFont(new java.awt.Font("Viner Hand ITC",
                BOLD,
                24)); // NOI18N
...
//                                .addContainerGap())
        ...
        ImageIcon i1;
        i1 =
                new ImageIcon(("Client/src/main/resources/" + image()));
        Image i2;
