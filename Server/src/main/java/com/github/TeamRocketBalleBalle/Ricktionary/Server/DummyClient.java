            ...
            while (true) {
                ...
                switch (serverPacket.getPacketType()) {
                    case 0 -> {
                        ...
                        ClientPacket meme = new ClientPacket(PacketType.INITIALISE, ((ServerPacket) o).getOrder(),
                                ...
                                public void run() {
                                    ...
                                    while (true) {
                                        try {
                                            ...
                                            ClientPacket textMessage = new ClientPacket(PacketType.GAME_INPUT, null,
                                                    new Reply<>(input));
                    ...
                    case 4 -> {
                        ...
                        ClientPacket imageLoaded = new ClientPacket(PacketType.LOAD_IMG, serverPacket.getOrder(),
                                new Reply<Boolean>(true));
                        out2.writeObject(imageLoaded);
                        logger.info("replied to load image: {},{},{}", imageLoaded.getPacketType(),
                                imageLoaded.getReplyingTo(), imageLoaded.getReply());
                    }
                    case 5 -> {
                        System.out.println("send input to server: ");

                        ClientPacket gameInput = new ClientPacket(PacketType.GAME_INPUT, serverPacket.getOrder(),
